...
import {
  listEntriesHandler,
  getEntryHandler,
  getStudentEntriesHandler,
  createEntryHandler,
  updateEntryHandler,
  deleteEntryHandler,
  getEntriesByDayHandler,
} from "./timetable.controller.js";
import { guard } from "../../shared/rbac/guard.js";
 ...
 *   get:
 *     summary: Get timetable entries for a specific student (parent/admin access)
 *     tags: [Timetable]
 *     security:
 *       - BearerAuth: []
 *     parameters:
 ...
 *     responses:
 *       200:
 *         description: Student timetable entries
 */
timetableRoutes.get(
  "/student/:studentId",
  guard({
