...
const quizQuestionReviewUpdateSchema = z.object({
...
export const quizUpdateSchema = z.object({
  ...
  capsTags: z.array(z.string()).optional(),
  revealCorrectAnswers: z.boolean().optional(),
  revealToParents: z.boolean().optional(),
  questions: z.array(quizQuestionReviewUpdateSchema).min(1).optional(),
});
