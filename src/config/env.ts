...
export const env = {
  ...
  novuApiBaseUrl: process.env.NOVU_API_BASE_URL ?? "https://api.novu.co",
  novuWorkflowIdOtp: process.env.NOVU_WORKFLOW_ID_OTP ?? "",
  novuWorkflowIdLoginAlert: process.env.NOVU_WORKFLOW_ID_LOGIN_ALERT ?? "",
  authEnforceEmailVerification: toBoolean(
    process.env.AUTH_ENFORCE_EMAIL_VERIFICATION,
    false,
  ),
  authEnableLoginAlerts: toBoolean(process.env.AUTH_ENABLE_LOGIN_ALERTS, true),
