...
export const questionBankItems = pgTable("question_bank_items", {
  ...
  answerFormat: varchar("answer_format", { length: 32 }),
  rubricCriteria: jsonb("rubric_criteria").$type<unknown>().default(null),
  practicalConfig: jsonb("practical_config").$type<unknown>().default(null),
